...
When a skill mentions a canonical role, use its corresponding tracker label from this table. Edit the right-hand column if the repository later adopts different label names.
